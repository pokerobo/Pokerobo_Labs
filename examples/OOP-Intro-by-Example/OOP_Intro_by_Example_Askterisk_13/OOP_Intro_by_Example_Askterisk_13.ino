...
FanAsterisk asterisk(&displayHandler, &joystickHandler, asteriskRadius);
FanAsterisk asterisk1(&asterisk);
FanAsterisk asterisk2(&asterisk);
FanAsterisk asterisk3(&asterisk);
